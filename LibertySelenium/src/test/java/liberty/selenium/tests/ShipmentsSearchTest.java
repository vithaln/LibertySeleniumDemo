...
//						Thread.sleep(3000);
	...
	public void searchByDate() throws InterruptedException {
		...
		Thread.sleep(1000); // choose month
	...
	public void clearDateFields() throws InterruptedException {
		...
		WebElement fromDate = driver
				.findElement(By.xpath("//span[@id='fromDate']//span[@class='p-button-icon p-c pi pi-calendar']"));
		fromDate.click();
		Thread.sleep(2000);
		// choose month
		WebElement chooseMonth = driver.findElement(By.xpath("//select[@class='p-datepicker-month']"));
		...
		if (fromDateField.isBlank() && toDateField.isBlank()) {
			...
			System.out.println("Test case failled, FromDate and toDate Input field is not empty..");
		}
	...
	@Test
	@Order(2)
	public void clearOrderField() throws InterruptedException {
		...
		if (textInsideInputBox.isEmpty()) {
			System.out.println("Test case passed, Search By Order Input field is empty");
		} else {
			System.out.println("Test case failled, Search By Order Input field is not empty..");
		}
	...
	public void searchByOrder() throws InterruptedException {
		...
		Thread.sleep(4000);
		  ...
		  //Scrolldown the page //JavascriptExecutor js=(JavascriptExecutor)driver;
			JavascriptExecutor js = (JavascriptExecutor) driver;
		  js.executeScript("window.scrollBy(0,350)", "");
	...
	@Test
	@Order(4)
	public void clearPickticket() throws InterruptedException {
				  ...
				  if(textInsideInputBox.isEmpty())
				  {
				  System.out.println("Test case passed, Search By Pickticket Input field is empty");
				  } else
				  {
				  System.out.println("Test case failled, Search By Pickticket Input field is not empty..");
				  }
...
//			}
		...
		String expectedStatus = "Printed";
		if (actualstatus.equals(expectedStatus))
		{
			System.out.println("Test case passed because first status matched with expected status after displaying data  ..");
		} else 
		{
			System.out.println("Test case failled because first status is not matched with expected status after displaying data  ..");
		}
	...
	@Test
	@Order(6)
	public void clearStatusFields() throws InterruptedException {
				  ...
				  //select Printed
				  driver.findElement(By.xpath("//li[text()='Printed']")).click();
				  Thread.sleep(2000); //click on to Status button 
				  WebElement toStatus =driver.findElement(By.xpath("//body[1]/div[1]/div[2]/div[1]/div[3]/div[1]/div[1]/div[2]/div[3]/div[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]")); 
				  toStatus.click(); 
				  //select In Packing
				  driver.findElement(By.xpath("//li[text()='In Packing']")).click();
				  Thread.sleep(2000); 
				...
				Thread.sleep(2000);
				  ...
				  {
				  System.out.println("Test case failled, FromStatus and toStatus dropdown field is not empty..");
				  }
